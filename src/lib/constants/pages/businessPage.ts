  ...
  ar: {
    hero: {
      ...
      answerBlock: {
        ...
        answer:
          'ديزي منصة لأعمال التجميل مدعومة بالذكاء الاصطناعي، تجمع بين موظف استقبال ذكي يعمل على مدار الساعة ويتولى رسائل واتساب وإنستغرام، وبين إدارة الحجوزات واستقطاب العملاء والمدفوعات وجدولة الموظفين والتسويق. وهي تستبدل 8 أدوات منفصلة بمنصة واحدة متعددة اللغات تدعم حاليًا العربية والإنجليزية.',
      },
    },
    platformStrengths: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: 'ابدأ العمل. موظف الاستقبال الذكي يتولى المهمة.', description: 'يحصل العملاء على ردود فورية، وتبقى أنت متحكمًا بالكامل.' },
      ],
    },
    pricingHook: {
    ...
    scrollSections: [
      {
        ...
        mainImageHeight: 500,
        infoScroll: {
          title: 'لدى العميل سؤال',
          text: 'موظف الاستقبال الذكي يرد فورًا',
          description:
            'يرسل أحد العملاء رسالة واتساب الساعة 9 مساءً يسأل فيها عن توفر موعد للبالاياج. يرد موظف الاستقبال الذكي خلال ثوانٍ بأسلوب ودود واحترافي وبلغته المفضلة.',
          listSub: [
      ...
      },
      {
        ...
        mainImageHeight: 500,
        infoScroll: {
          title: 'يتم الدفع قبل وصول العميل',
          text: 'عربون، دفعة كاملة، أو الدفع عند الزيارة',
          description:
            'يدفع العميل عربونًا أو المبلغ الكامل مباشرة في المحادثة. وعند وصوله، يكون كل شيء جاهزًا.',
          listSub: [
            'دفع آمن في المحادثة',
      ...
      },
      {
        ...
        infoScroll: {
          ...
          text: 'لم تحرك ساكنًا',
          description:
            'يظهر الموعد في تقويمك بكل التفاصيل: الخدمة، والوقت، والموظف، وحالة الدفع. ويتمتع عميلك بتجربة مثالية، بينما تكون أنت في المنزل مع عائلتك.',
          listSub: [
