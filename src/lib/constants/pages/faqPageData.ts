      ...
      categories: [
        ...
        },
        {
          ...
          questions: [
            ...
            { question: 'هل أدفع عمولة على عملائي الحاليين؟', answer: 'لا. العمولة تُفرض فقط على العملاء الجدد الذين يكتشفونك ويحجزون عبر سوق ديزي. العملاء الذين تجلبهم بنفسك إلى المنصة بدون عمولة، دائماً.' },
          ],
        },
        {
          ...
          questions: [
            ...
            { question: 'هل يمكنني تخصيص ما يقوله الذكاء الاصطناعي؟', answer: 'نعم. أنت تحدد النبرة والمعلومات التي يشاركها وحدود ما يمكنه التعامل معه. على سبيل المثال، يمكنك توجيهه لتقديم عرض ترويجي معين دائماً أو تصعيد طلبات معينة إلى شخص حقيقي.' },
        ...
        },
        {
          ...
          questions: [
            { question: 'كيف تعمل العمولة؟', answer: 'العمولة تُفرض فقط على العملاء الجدد الذين يجدونك ويحجزون عبر سوق ديزي. عملاؤك الحاليون والحجوزات المباشرة بدون عمولة دائماً. نسبة العمولة شفافة وثابتة — بدون مفاجآت.' },
      ...
      categories: [
        ...
        },
        {
          ...
          questions: [
            ...
            { question: 'كم كاشباك أكسب؟', answer: 'نسب الكاشباك تختلف حسب مقدم الخدمة والخدمة، عادة تتراوح بين 3% و15%. بعض مقدمي الخدمات يقدمون عروضاً خاصة بنسب كاشباك أعلى. مبلغ الكاشباك يُعرض دائماً قبل تأكيد الحجز.' },
            ...
            { question: 'هل يمكنني التحقق من رصيد الكاشباك؟', answer: 'نعم. رصيدك الحالي مرئي دائماً في قسم المحفظة في التطبيق. يمكنك أيضاً عرض سجل كامل للكاشباك المكتسب والمستخدم.' },
