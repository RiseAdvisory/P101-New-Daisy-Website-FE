...
export const testimonialsList = [
  ...
  {
    text: 'Perfect choice for a SaaS application',
    author: 'Robert Brown',
    role: 'Web developer @themesberg',
    image: Robert,
    description:
  ...
  {
    text: 'Mindblowing workflow and variants',
  ...
  {
    text: 'A must-have for designers',
