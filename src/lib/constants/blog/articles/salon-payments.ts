...
<p> اقبل النقد دائمًا بلطف. لا تجعل العميل يشعر أبدًا أن بقشيشه غير مريح. يمكنك ذكر الإكرامية الرقمية كخيار ("نحن نقبل أيضًا الإكراميات رقميًا عند الخروج إذا كان ذلك أسهل في المرة القادمة") ولكن لا ترفض أبدًا أو تعيد توجيه الإكرامية النقدية في الوقت الحالي.</p>
