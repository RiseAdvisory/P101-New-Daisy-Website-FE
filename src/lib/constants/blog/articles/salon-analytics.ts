...
`,
    ...
    locale: 'en',
    sortId: 114,
    tags: { digital: 'Salon Analytics', wellness: 'KPIs' },
    user: defaultAuthor,
...
`,
    ...
    locale: 'en',
    sortId: 115,
    tags: { digital: 'Salon Analytics', wellness: 'ClientValue' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 21, attributes: { name: 'Salon Analytics' } } },
    picture: {
...
`,
    ...
    locale: 'en',
    sortId: 116,
    tags: { digital: 'Salon Analytics', wellness: 'Revenue' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 21, attributes: { name: 'Salon Analytics' } } },
    picture: {
...
`,
    ...
    locale: 'en',
    sortId: 117,
    tags: { digital: 'Salon Analytics', wellness: 'DataDriven' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 21, attributes: { name: 'Salon Analytics' } } },
    picture: {
