...
`,
    ...
    locale: 'en',
    sortId: 18,
    tags: { digital: 'Marketing', wellness: 'Loyalty' },
    user: defaultAuthor,
...
`,
    ...
    locale: 'en',
    sortId: 19,
    tags: { digital: 'Marketing', wellness: 'Referrals' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 8, attributes: { name: 'Marketing & Promotions' } } },
    picture: {
...
`,
    ...
    locale: 'en',
    sortId: 20,
    tags: { digital: 'Marketing', wellness: 'Email' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 8, attributes: { name: 'Marketing & Promotions' } } },
    picture: {
...
`,
    ...
    locale: 'en',
    sortId: 21,
    tags: { digital: 'Marketing', wellness: 'Social Media' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 8, attributes: { name: 'Marketing & Promotions' } } },
    picture: {
...
`,
    ...
    locale: 'en',
    sortId: 22,
    tags: { digital: 'Marketing', wellness: 'Cashback' },
    user: defaultAuthor,
    iconOwner: defaultIconOwner,
    category: { data: { id: 8, attributes: { name: 'Marketing & Promotions' } } },
    picture: {
