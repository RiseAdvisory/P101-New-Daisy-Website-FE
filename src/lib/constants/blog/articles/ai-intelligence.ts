...
<ul>
<li><strong>الرد على مكالمات ورسائل الحجز:</strong> 3-5 ساعات أسبوعياً، غالباً أثناء مواعيد العملاء، مما يؤدي إلى مقاطعات ومكالمات فائتة.</li>
...
<tr><td>العمولة</td><td>غالباً لكل حجز</td><td>بدون عمولة</td></tr>
</tbody>
</table>
