    ...
    categoryItems: {
      ...
      booking: [
        ...
        item(
          ...
          '/images/features/business/google-sync.png',
        ...
        item(
          ...
          '/images/features/business/smart-calendar.png',
          { padding: '24px 24px 24px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/smart-calendar-mobile.png',
      ...
      communication: [
        item(
          ...
          '/images/features/business/live-chat-support.png',
          { padding: '0px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/live-chat-support-mobile.png',
        ...
        item(
          ...
          '/images/features/business/meta-integrations.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/meta-integrations-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
      ],
      marketing: [
        item(
          ...
          '/images/features/business/marketing-flash.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/marketing-flash-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          2,
          ...
          '/images/features/business/marketing-promo.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/marketing-promo-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          3,
          ...
          '/images/features/business/marketing-rating.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/marketing-rating-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          4,
          ...
          '/images/features/business/marketing-marketplace.png',
          { padding: '24px 24px 24x 24px', objectFit: 'cover'},
          '/images/features/business/marketing-marketplace.png',
      ...
      payments: [
        item(
          ...
          '/images/features/business/payment-methods.png',
          { padding: '24px 24px 24px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/payment-methods.png',
        ...
        item(
          ...
          '/images/features/business/invoice-management.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/invoice-management-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          3,
          ...
          '/images/features/business/store-checkout.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/store-checkout.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          ...
          '/images/features/business/daisy-wallet.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/daisy-wallet-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
      ],
      growth: [
        item(
          ...
          '/images/features/business/client-management.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/client-management-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          2,
          ...
          '/images/features/business/multi-workspace.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/multi-workspace-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
      ],
      control: [
        ...
        item(
          ...
          '/images/features/business/roles-and-permissions.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/roles-and-permissions-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
      ],
      reports: [
        item(
          ...
          '/images/features/business/sales-analytics.png',
          { padding: '64px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/sales-analytics-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          2,
          ...
          '/images/features/business/staff-performance.png',
          { padding: '0px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/staff-performance-mobile.png',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          3,
          ...
          '/images/features/business/exportable-reports.png',
          { padding: '24px 24px 24px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/exportable-reports-mobile.png',
          { padding: '24px 24px 24px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
      ],
    },
