    ...
    categoryItems: {
      ...
      booking: [
        item(
          ...
          '/images/features/business/automated-reminders.webp',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/automated-reminders-mobile.webp',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          2,
      ...
      communication: [
        ...
        item(
          ...
          '/images/features/business/smart-notifications.webp',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
          '/images/features/business/smart-notifications-mobile.webp',
          { padding: '24px 24px 0px 24px', objectFit: 'cover', objectPosition: 'bottom' },
        ),
        item(
          3,
