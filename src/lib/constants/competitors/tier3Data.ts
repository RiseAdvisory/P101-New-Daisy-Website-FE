...
export const tier3Competitors: Record<string, CompetitorData> = {
  ...
  timely: {
    ...
    faq: [
      ...
      { question: 'How does Timely\'s mobile app compare to Daisy?', answer: 'Timely has a well-designed mobile app for scheduling and staff management. Daisy\'s mobile app adds AI receptionist access, marketplace visibility, cashback management, real-time business analytics, and full bilingual Arabic/English support.' },
  ...
  setmore: {
    ...
    faq: [
      ...
      { question: 'How does Setmore\'s mobile app compare to Daisy?', answer: 'Setmore has a basic mobile app for viewing and managing appointments. Daisy\'s mobile app provides full salon management, AI receptionist, marketplace visibility, cashback tracking, real-time analytics, and bilingual Arabic/English support.' },
  ...
  squire: {
    ...
    faq: [
      ...
      { question: 'How does SQUIRE\'s mobile app compare to Daisy?', answer: 'SQUIRE\'s mobile app is well-designed for barbershop management. Daisy\'s app provides broader beauty business management, AI receptionist access, GCC-wide marketplace visibility, cashback tracking, and bilingual Arabic/English support.' },
