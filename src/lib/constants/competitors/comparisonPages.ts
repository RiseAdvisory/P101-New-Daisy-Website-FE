...
export const daisyVsPages: DaisyVsPageData[] = [
  // P1: Tier 1 competitors
  {
    ...
    tldr: 'Fresha is a free marketplace with hidden transaction fees. Daisy is a complete growth platform with AI receptionist, cashback rewards, and Arabic support. Choose Fresha for marketplace exposure on a budget; choose Daisy to actively grow your business.',
    verdict:
      'Fresha excels as a free-to-start marketplace for cost-conscious solopreneurs, but its hidden fees add up fast and it lacks AI, Arabic support, and customer acquisition tools. Daisy is the better choice for businesses serious about growth, especially in the GCC market.',
    featureCommentary: {
      onlineBooking:
    ...
    whoShouldChooseCompetitor: [
      'You need the cheapest possible starting point (free base plan)',
...
export const alternativePages: AlternativePageData[] = [
  // P2: Tier 1
  {
    ...
    heroSubtitle: 'You loved the idea of free salon software — until the hidden fees started adding up.',
    painPoints: [
...
export const bestAlternativesPages: BestAlternativesPageData[] = [
  // P2: Tier 1
  {
    ...
    heroSubtitle: 'Fresha\'s "free" model is getting expensive. Here are the best alternatives for growing beauty businesses.',
    intro: 'Fresha is the world\'s largest beauty marketplace, but hidden transaction fees, 20% marketplace commissions, and no AI features are pushing businesses to look elsewhere. We\'ve compared the top alternatives based on features, pricing, AI capabilities, and international support.',
...
export const competitorVsPages: CompetitorVsPageData[] = [
  // P2
  {
    ...
    verdict: 'Fresha wins on marketplace scale and free starting price. Booksy wins on mobile experience and has a basic AI voice feature (Digital Doorman). Neither offers Arabic support, full AI ecosystem, or cashback-driven customer acquisition.',
    whoShouldChooseA: [
      'You want a free starting point with marketplace exposure',
  ...
  },
  {
    ...
    metaTitle: 'Fresha vs Vagaro: Free vs Feature-Rich (2026)',
    metaDescription: 'Compare Fresha (free with fees) and Vagaro (feature-rich at $30/mo). Pricing, features, and which is better for your salon.',
    keywords: ['fresha vs vagaro', 'fresha or vagaro', 'vagaro vs fresha'],
    heroTitle: 'Fresha vs Vagaro',
    heroSubtitle: '"Free" with hidden fees versus $30/mo with comprehensive features — which model works better?',
    verdict: 'Fresha appears cheaper but hidden fees add up. Vagaro offers more features at a predictable $30/mo. Neither has AI receptionist, Arabic support, or cashback rewards.',
    whoShouldChooseA: [
  ...
  },
  {
    ...
    metaDescription: 'Compare Fresha (free marketplace) and GlossGenius ($24/mo beauty-focused). Features, pricing, and which suits your salon better.',
    keywords: ['fresha vs glossgenius', 'fresha or glossgenius'],
    heroTitle: 'Fresha vs GlossGenius',
    heroSubtitle: 'Free marketplace with hidden fees versus beautiful design at $24/mo — which trade-off works for you?',
    ...
    whoShouldChooseA: ['You want free software with marketplace', 'Client discovery through marketplace matters most', 'You\'re comfortable with transaction fees'],
  ...
  },
  {
    ...
    metaTitle: 'Fresha vs Mindbody: Free vs Enterprise (2026)',
    metaDescription: 'Compare Fresha (free marketplace) and Mindbody ($139+/mo enterprise). Two extremes of salon software — plus a modern alternative.',
    keywords: ['fresha vs mindbody', 'fresha or mindbody'],
    heroTitle: 'Fresha vs Mindbody',
    heroSubtitle: 'The free marketplace versus the enterprise legacy — two extremes of beauty business software.',
    verdict: 'Fresha is better for cost-conscious small businesses. Mindbody is better for large enterprise operations. Both lack AI receptionist, Arabic, and cashback.',
    whoShouldChooseA: ['Cost is the top priority', 'You want marketplace without monthly fees', 'You\'re a small salon'],
    whoShouldChooseB: ['Enterprise features are required', 'Large fitness marketplace matters', 'Multi-location management needed'],
    daisyPitch: 'Between free-with-fees and expensive-enterprise, Daisy offers the modern middle: full AI, Arabic support, cashback, and growth tools at accessible pricing.',
  },
  {
    slugA: 'booksy',
    slugB: 'boulevard',
