...
export const alternativePages: AlternativePageData[] = [
  ...
  },
  {
    ...
    switchingReasons: [
      ...
      'White-label brand control included',
    ],
  ...
  },
  {
    ...
    painPoints: [
      ...
      'No Arabic or GCC market support',
      'Per-user pricing scales painfully as you grow',
    ],
    switchingReasons: [
      'AI receptionist handles bookings, payments, and customer service 24/7',
      'Complete beauty platform: booking + POS + CRM + AI in one',
      'Consumer marketplace with cashback drives new clients to you',
      'Arabic/English support built for GCC markets',
      'Flat pricing that doesn\'t punish you for hiring',
      'White-label brand control for your salon identity',
    ],
    topAlternatives: ['fresha', 'vagaro', 'booksy', 'glossgenius'],
  },
  {
