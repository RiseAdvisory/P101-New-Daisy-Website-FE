...
const aiMarketingAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  business: {
    en: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'AI Identifies Lapsed Customers', text: 'They Haven\'t Visited in a While', description: 'The AI notices a regular customer hasn\'t booked in 6 weeks. Based on their usual visit pattern, it determines they are overdue and ready for a nudge.', listSub: ['Tracks visit frequency per customer', 'Detects when customers are overdue', 'No manual tracking required'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Personalizes the Perfect Offer', text: 'Based on Their Preferences', description: 'The AI creates a personalized message based on the customer\'s favorite services and past bookings. It is not a generic promotion, it is a tailored invitation.', listSub: ['Uses service history and preferences', 'Personalizes message content', 'Optimizes timing for best response'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/integrations.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Sends via WhatsApp Automatically', text: 'The Right Channel at the Right Time', description: 'The personalized offer is sent via WhatsApp, where the customer is most likely to see and act on it. The AI handles the entire campaign without you writing a single message.', listSub: ['WhatsApp delivery for high open rates', 'Automated sending at optimal times', 'Zero manual effort required'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Customer Rebooks', text: 'Retention on Autopilot', description: 'The customer sees the personalized message, taps to rebook, and the AI handles the rest. Your calendar fills up and your revenue grows, all without marketing effort.', listSub: ['One-tap rebooking from the message', 'Revenue recovered from lapsed clients', 'Retention improves automatically'] } },
      ],
      socialProofStats: [
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'الذكاء الاصطناعي يحدد العملاء المتأخرين', text: 'لم يزوروا منذ فترة', description: 'الذكاء الاصطناعي يلاحظ أن عميلًا منتظمًا لم يحجز منذ 6 أسابيع. بناءً على نمط زياراته المعتاد، يحدد أنه متأخر وجاهز للتذكير.', listSub: ['يتتبع تكرار الزيارات لكل عميل', 'يكشف متى يتأخر العملاء', 'بدون تتبع يدوي مطلوب'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يخصص العرض المثالي', text: 'بناءً على تفضيلاتهم', description: 'الذكاء الاصطناعي يصنع رسالة مخصصة بناءً على الخدمات المفضلة للعميل والحجوزات السابقة. ليس عرضًا ترويجيًا عامًا، بل دعوة مخصصة.', listSub: ['يستخدم سجل الخدمات والتفضيلات', 'يخصص محتوى الرسالة', 'يحسّن التوقيت لأفضل استجابة'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/integrations.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يرسل عبر واتساب تلقائيًا', text: 'القناة المناسبة في الوقت المناسب', description: 'العرض المخصص يُرسل عبر واتساب، حيث يكون العميل أكثر احتمالًا لرؤيته والتفاعل معه. الذكاء الاصطناعي يدير الحملة بالكامل دون أن تكتب رسالة واحدة.', listSub: ['تسليم واتساب لمعدلات فتح عالية', 'إرسال تلقائي في الأوقات المثلى', 'بدون أي جهد يدوي مطلوب'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'العميل يعيد الحجز', text: 'الاحتفاظ على الطيار الآلي', description: 'العميل يرى الرسالة المخصصة وينقر لإعادة الحجز والذكاء الاصطناعي يتولى الباقي. تقويمك يمتلئ وإيراداتك تنمو، كل ذلك بدون جهد تسويقي.', listSub: ['إعادة حجز بنقرة واحدة من الرسالة', 'إيرادات مستعادة من العملاء المتأخرين', 'الاحتفاظ يتحسن تلقائيًا'] } },
      ],
      socialProofStats: [
  ...
  professional: {
    en: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Notices a Client Is Due for a Visit', text: 'Perfect Timing, Every Time', description: 'A regular client usually rebooks every 4 weeks. The AI notices it has been 5 weeks and triggers a personalized reminder before they book somewhere else.', listSub: ['Detects overdue clients automatically', 'Timing based on individual patterns', 'Prevents clients from drifting away'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Sends Personalized Reminder', text: 'Not a Generic Message. A Personal Touch.', description: 'The AI sends a WhatsApp message referencing their last service and suggesting their next appointment. It feels personal because it is based on real data, not a template.', listSub: ['References their last visit', 'Suggests relevant services', 'Feels personal, not automated'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Client Rebooks Automatically', text: 'Your Calendar Grows. You Did Nothing.', description: 'The client taps to rebook from the WhatsApp message. The AI confirms the appointment and updates your calendar. Your retention rate climbs without any marketing effort.', listSub: ['One-tap rebooking from WhatsApp', 'Calendar updated automatically', 'Higher retention, zero effort'] } },
      ],
      socialProofStats: [
    ...
    ar: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يلاحظ أن العميل حان وقت زيارته', text: 'التوقيت المثالي، في كل مرة', description: 'عميل منتظم يعيد الحجز كل 4 أسابيع عادةً. الذكاء الاصطناعي يلاحظ مرور 5 أسابيع ويطلق تذكيرًا مخصصًا قبل أن يحجز في مكان آخر.', listSub: ['يكشف العملاء المتأخرين تلقائيًا', 'التوقيت مبني على أنماط فردية', 'يمنع ابتعاد العملاء'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يرسل تذكيرًا مخصصًا', text: 'ليست رسالة عامة. لمسة شخصية.', description: 'الذكاء الاصطناعي يرسل رسالة واتساب تشير إلى آخر خدمة وتقترح الموعد التالي. تبدو شخصية لأنها مبنية على بيانات حقيقية، ليس قالبًا.', listSub: ['يشير إلى آخر زيارة', 'يقترح خدمات ذات صلة', 'يبدو شخصيًا، ليس آليًا'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'العميل يعيد الحجز تلقائيًا', text: 'تقويمك ينمو. لم تفعل شيئًا.', description: 'العميل ينقر لإعادة الحجز من رسالة واتساب. الذكاء الاصطناعي يؤكد الموعد ويحدث تقويمك. معدل الاحتفاظ يرتفع بدون أي جهد تسويقي.', listSub: ['إعادة حجز بنقرة واحدة من واتساب', 'التقويم يتحدث تلقائيًا', 'احتفاظ أعلى، بدون جهد'] } },
      ],
      socialProofStats: [
