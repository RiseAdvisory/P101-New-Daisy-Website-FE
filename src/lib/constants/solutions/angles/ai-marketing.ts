...
const aiMarketingAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  business: {
    en: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'AI Identifies Lapsed Customers', text: 'They Haven\'t Visited in a While', description: 'The AI notices a regular customer hasn\'t booked in 6 weeks. Based on their usual visit pattern, it determines they are overdue and ready for a nudge.', listSub: ['Tracks visit frequency per customer', 'Detects when customers are overdue', 'No manual tracking required'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Personalizes the Perfect Offer', text: 'Based on Their Preferences', description: 'The AI creates a personalized message based on the customer\'s favorite services and past bookings. It is not a generic promotion, it is a tailored invitation.', listSub: ['Uses service history and preferences', 'Personalizes message content', 'Optimizes timing for best response'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/payment-collection.webp', mainImageMobile: '/images/pages/business/scroll/payment-collection-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Sends via WhatsApp Automatically', text: 'The Right Channel at the Right Time', description: 'The personalized offer is sent via WhatsApp, where the customer is most likely to see and act on it. The AI handles the entire campaign without you writing a single message.', listSub: ['WhatsApp delivery for high open rates', 'Automated sending at optimal times', 'Zero manual effort required'] } },
  ...
  professional: {
    en: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Notices a Client Is Due for a Visit', text: 'Perfect Timing, Every Time', description: 'A regular client usually rebooks every 4 weeks. The AI notices it has been 5 weeks and triggers a personalized reminder before they book somewhere else.', listSub: ['Detects overdue clients automatically', 'Timing based on individual patterns', 'Prevents clients from drifting away'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', mainImageMobile: '/images/pages/business/scroll/booking-confirmed-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Sends Personalized Reminder', text: 'Not a Generic Message. A Personal Touch.', description: 'The AI sends a WhatsApp message referencing their last service and suggesting their next appointment. It feels personal because it is based on real data, not a template.', listSub: ['References their last visit', 'Suggests relevant services', 'Feels personal, not automated'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Client Rebooks Automatically', text: 'Your Calendar Grows. You Did Nothing.', description: 'The client taps to rebook from the WhatsApp message. The AI confirms the appointment and updates your calendar. Your retention rate climbs without any marketing effort.', listSub: ['One-tap rebooking from WhatsApp', 'Calendar updated automatically', 'Higher retention, zero effort'] } },
      ],
      socialProofStats: [
