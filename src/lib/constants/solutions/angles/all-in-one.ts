...
const allInOneAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  business: {
    en: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'See Your Current Tool Stack', text: '5+ Apps. Multiple Logins. Monthly Bills.', description: 'Right now you are paying for a booking app, a messaging tool, a payment processor, a marketing platform, and maybe more. Different logins, different invoices, no integration between them.', listSub: ['Multiple subscriptions adding up', 'Data siloed across platforms', 'No connection between tools'] } },
  ...
  professional: {
    en: {
      ...
      scrollSections: [
        ...
        { sortId: 4, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Everything in One App', text: 'Open Daisy. See Your Whole Career.', description: 'Schedule, bookings, payments, clients, portfolio, earnings, and AI assistant all in one app. No switching between tools. No missing information. Just your career, organized.', listSub: ['One app, one login', 'All your data in one place', 'Works on phone, tablet, and web'] } },
      ],
      socialProofStats: [
