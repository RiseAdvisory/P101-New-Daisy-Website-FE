...
const allInOneAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  business: {
    en: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'See Your Current Tool Stack', text: '5+ Apps. Multiple Logins. Monthly Bills.', description: 'Right now you are paying for a booking app, a messaging tool, a payment processor, a marketing platform, and maybe more. Different logins, different invoices, no integration between them.', listSub: ['Multiple subscriptions adding up', 'Data siloed across platforms', 'No connection between tools'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Watch Daisy Replace Each One', text: 'One by One, They All Fold Into Daisy', description: 'Booking software, replaced. Payment processor, built in. Marketing tools, automated by AI. Staff scheduling, unified. Analytics, one dashboard. Every tool you were paying for separately now lives in one platform.', listSub: ['Each tool replaced, not just duplicated', 'AI connects everything together', 'Data flows between all features'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/integrations.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Everything in One Dashboard', text: 'One Login. Complete Visibility.', description: 'Open Daisy and see everything: bookings, messages, payments, staff schedules, analytics, and marketing all in one view. No switching between apps. No missing context.', listSub: ['Single dashboard for everything', 'Real-time data across all features', 'Complete business visibility'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'One Subscription. One Invoice.', text: 'Simpler. Cheaper. Better.', description: 'Instead of 5+ separate subscriptions, you pay one price for everything. The cost is lower than your current tool stack, and the experience is far better because everything works together.', listSub: ['One price for 8 tools', 'Lower total cost than separate tools', 'No integration headaches'] } },
      ],
      socialProofStats: [
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'انظر إلى أدواتك الحالية', text: '+5 تطبيقات. تسجيلات دخول متعددة. فواتير شهرية.', description: 'حاليًا أنت تدفع لتطبيق حجز وأداة مراسلة ومعالج دفع ومنصة تسويق وربما أكثر. تسجيلات دخول مختلفة، فواتير مختلفة، بدون تكامل بينها.', listSub: ['اشتراكات متعددة تتراكم', 'البيانات معزولة عبر المنصات', 'بدون ربط بين الأدوات'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'شاهد ديزي تستبدل كل واحدة', text: 'واحدة تلو الأخرى، كلها تنضم إلى ديزي', description: 'برنامج الحجز، تم استبداله. معالج الدفع، مدمج. أدوات التسويق، مؤتمتة بالذكاء الاصطناعي. جدولة الموظفين، موحدة. التحليلات، لوحة تحكم واحدة. كل أداة كنت تدفع لها بشكل منفصل الآن في منصة واحدة.', listSub: ['كل أداة تُستبدل، ليس فقط تُنسخ', 'الذكاء الاصطناعي يربط كل شيء معًا', 'البيانات تتدفق بين جميع الميزات'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/integrations.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'كل شيء في لوحة تحكم واحدة', text: 'تسجيل دخول واحد. رؤية كاملة.', description: 'افتح ديزي واطلع على كل شيء: الحجوزات والرسائل والمدفوعات وجداول الموظفين والتحليلات والتسويق في عرض واحد. بدون تبديل بين التطبيقات. بدون سياق مفقود.', listSub: ['لوحة تحكم واحدة لكل شيء', 'بيانات في الوقت الفعلي عبر جميع الميزات', 'رؤية كاملة للعمل'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'اشتراك واحد. فاتورة واحدة.', text: 'أبسط. أرخص. أفضل.', description: 'بدلاً من +5 اشتراكات منفصلة، تدفع سعرًا واحدًا لكل شيء. التكلفة أقل من مجموع أدواتك الحالية، والتجربة أفضل بكثير لأن كل شيء يعمل معًا.', listSub: ['سعر واحد لـ 8 أدوات', 'تكلفة إجمالية أقل من الأدوات المنفصلة', 'بدون صداع التكامل'] } },
      ],
      socialProofStats: [
  ...
  professional: {
    en: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Your Payment App: Gone.', text: 'Daisy Processes Payments', description: 'No more awkward payment conversations or separate payment tools. Clients pay through the app before or after their appointment. Earnings tracked automatically.', listSub: ['In-app payment processing', 'Automatic receipts and tracking', 'Weekly payouts to your bank'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Your Marketing Effort: Gone.', text: 'AI Handles Client Retention', description: 'No more manually chasing clients for rebookings. The AI learns preferences and sends personalized reminders automatically. Your retention rate climbs without you lifting a finger.', listSub: ['Personalized rebooking reminders', 'AI learns client preferences', 'Zero manual marketing effort'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Everything in One App', text: 'Open Daisy. See Your Whole Career.', description: 'Schedule, bookings, payments, clients, portfolio, earnings, and AI assistant all in one app. No switching between tools. No missing information. Just your career, organized.', listSub: ['One app, one login', 'All your data in one place', 'Works on phone, tablet, and web'] } },
      ],
      socialProofStats: [
    ...
    ar: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'تطبيق الدفع: اختفى.', text: 'ديزي تعالج المدفوعات', description: 'لا مزيد من محادثات الدفع المحرجة أو أدوات الدفع المنفصلة. العملاء يدفعون عبر التطبيق قبل أو بعد موعدهم. الأرباح تُتتبع تلقائيًا.', listSub: ['معالجة الدفع في التطبيق', 'إيصالات وتتبع تلقائي', 'دفعات أسبوعية لحسابك البنكي'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/analytics.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'جهد التسويق: اختفى.', text: 'الذكاء الاصطناعي يتولى الاحتفاظ بالعملاء', description: 'لا مزيد من ملاحقة العملاء يدويًا لإعادة الحجز. الذكاء الاصطناعي يتعلم التفضيلات ويرسل تذكيرات مخصصة تلقائيًا. معدل الاحتفاظ يرتفع دون أن تحرك ساكنًا.', listSub: ['تذكيرات إعادة حجز مخصصة', 'الذكاء الاصطناعي يتعلم تفضيلات العملاء', 'بدون جهد تسويقي يدوي'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/device-mockups.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'كل شيء في تطبيق واحد', text: 'افتح ديزي. اطلع على مسيرتك بأكملها.', description: 'الجدول والحجوزات والمدفوعات والعملاء والمعرض والأرباح ومساعد الذكاء الاصطناعي كلها في تطبيق واحد. بدون تبديل بين الأدوات. بدون معلومات مفقودة. فقط مسيرتك، منظمة.', listSub: ['تطبيق واحد، تسجيل دخول واحد', 'كل بياناتك في مكان واحد', 'يعمل على الهاتف والتابلت والويب'] } },
      ],
      socialProofStats: [
