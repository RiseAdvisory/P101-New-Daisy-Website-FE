...
const allInOneAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  business: {
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/device-mockups.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', secondBg: '/images/pages/business/scroll/stars.png', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'انظر إلى أدواتك الحالية', text: '+5 تطبيقات. تسجيلات دخول متعددة. فواتير شهرية.', description: 'حاليًا أنت تدفع لتطبيق حجز وأداة مراسلة ومعالج دفع ومنصة تسويق وربما أكثر. تسجيلات دخول مختلفة، فواتير مختلفة، بدون تكامل بينها.', listSub: ['اشتراكات متعددة تتراكم', 'البيانات معزولة عبر المنصات', 'بدون ربط بين الأدوات'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'شاهد ديزي تستبدل كل واحدة', text: 'واحدة تلو الأخرى، كلها تنضم إلى ديزي', description: 'برنامج الحجز، تم استبداله. معالج الدفع، مدمج. أدوات التسويق، مؤتمتة بالذكاء الاصطناعي. جدولة الموظفين، موحدة. التحليلات، لوحة تحكم واحدة. كل أداة كنت تدفع لها بشكل منفصل الآن في منصة واحدة.', listSub: ['كل أداة تُستبدل، ليس فقط تُنسخ', 'الذكاء الاصطناعي يربط كل شيء معًا', 'البيانات تتدفق بين جميع الميزات'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/integrations.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', secondBg: '/images/pages/business/scroll/stars.png', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'كل شيء في لوحة تحكم واحدة', text: 'تسجيل دخول واحد. رؤية كاملة.', description: 'افتح ديزي واطلع على كل شيء: الحجوزات والرسائل والمدفوعات وجداول الموظفين والتحليلات والتسويق في عرض واحد. بدون تبديل بين التطبيقات. بدون سياق مفقود.', listSub: ['لوحة تحكم واحدة لكل شيء', 'بيانات في الوقت الفعلي عبر جميع الميزات', 'رؤية كاملة للعمل'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/analytics.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'اشتراك واحد. فاتورة واحدة.', text: 'أبسط. أرخص. أفضل.', description: 'بدلاً من +5 اشتراكات منفصلة، تدفع سعرًا واحدًا لكل شيء. التكلفة أقل من مجموع أدواتك الحالية، والتجربة أفضل بكثير لأن كل شيء يعمل معًا.', listSub: ['سعر واحد لـ 8 أدوات', 'تكلفة إجمالية أقل من الأدوات المنفصلة', 'بدون صداع التكامل'] } },
      ],
      socialProofStats: [
  ...
  professional: {
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/professional/scroll/staff-details.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', secondBg: '/images/pages/business/scroll/stars.png', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'تطبيق الجدولة: اختفى.', text: 'ديزي تدير تقويمك', description: 'لا مزيد من تطبيق جدولة منفصل. ديزي تدير توافرك وتقبل الحجوزات على مدار الساعة وتمنع الحجوزات المزدوجة. تقويمك يمتلئ بنفسه بينما تركز على العملاء.', listSub: ['حدد الساعات عبر مواقع متعددة', 'الذكاء الاصطناعي يقبل الحجوزات أثناء عملك', 'بدون تعارضات في الجدولة'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'تطبيق الدفع: اختفى.', text: 'ديزي تعالج المدفوعات', description: 'لا مزيد من محادثات الدفع المحرجة أو أدوات الدفع المنفصلة. العملاء يدفعون عبر التطبيق قبل أو بعد موعدهم. الأرباح تُتتبع تلقائيًا.', listSub: ['معالجة الدفع في التطبيق', 'إيصالات وتتبع تلقائي', 'دفعات أسبوعية لحسابك البنكي'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/analytics.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', secondBg: '/images/pages/business/scroll/stars.png', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'جهد التسويق: اختفى.', text: 'الذكاء الاصطناعي يتولى الاحتفاظ بالعملاء', description: 'لا مزيد من ملاحقة العملاء يدويًا لإعادة الحجز. الذكاء الاصطناعي يتعلم التفضيلات ويرسل تذكيرات مخصصة تلقائيًا. معدل الاحتفاظ يرتفع دون أن تحرك ساكنًا.', listSub: ['تذكيرات إعادة حجز مخصصة', 'الذكاء الاصطناعي يتعلم تفضيلات العملاء', 'بدون جهد تسويقي يدوي'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/device-mockups.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'كل شيء في تطبيق واحد', text: 'افتح ديزي. اطلع على مسيرتك بأكملها.', description: 'الجدول والحجوزات والمدفوعات والعملاء والمعرض والأرباح ومساعد الذكاء الاصطناعي كلها في تطبيق واحد. بدون تبديل بين الأدوات. بدون معلومات مفقودة. فقط مسيرتك، منظمة.', listSub: ['تطبيق واحد، تسجيل دخول واحد', 'كل بياناتك في مكان واحد', 'يعمل على الهاتف والتابلت والويب'] } },
      ],
      socialProofStats: [
