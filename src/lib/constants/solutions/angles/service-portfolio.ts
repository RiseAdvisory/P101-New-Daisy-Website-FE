  ...
  business: {
    en: {
      hero: {
        ...
        subHeadline: 'Service menus with photos, videos and real descriptions, so customers can see exactly what they are booking. Confidence is what converts.',
        ctaText: 'Start Your 14-Day Free Trial',
        ctaLink: '/get-the-app',
        trustLine: 'No credit card required. Our team helps you set up.',
        answerBlock: { question: 'What is a visual service portfolio for beauty businesses?', answer: 'It lets you present your services with photos, videos, descriptions and pricing nobody has to ask about. Customers browse the menu, see examples of your work and book knowing what they are getting. Visual menus convert considerably better.' },
      },
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Customer Browses Your Service Menu', text: 'Visual. Detailed. Compelling.', description: 'They open your service page to a menu that is actually organised. Every service has photos, a description, a duration and a price, so there is nothing left to guess.', listSub: ['Photos and videos for each service', 'Clear descriptions and duration', 'Transparent pricing builds confidence'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'They See Photos and Videos', text: 'Your Best Work on Display', description: 'Before and after photos, styling videos and client testimonials show people what they are going to get. Seeing it removes the hesitation.', listSub: ['Before/after transformation photos', 'Service showcase videos', 'Real client testimonials'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/payment-collection.webp', mainImageMobile: '/images/pages/business/scroll/payment-collection-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'They Pick with Confidence', text: 'No Guesswork. Just Certainty.', description: 'They choose exactly the service they want, with no confusion about what is included, how long it takes or what it costs. They book because they already trust the outcome.', listSub: ['Service details eliminate confusion', 'Multiple categories organized clearly', 'Add-ons and packages visible'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', mainImageMobile: '/images/pages/business/scroll/booking-confirmed-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'They Book Immediately', text: 'Confidence Converts to Revenue', description: 'They book, pick a time and pay. The portfolio did the selling, and you got a confirmed booking without exchanging a message.', listSub: ['Higher conversion from visual menus', 'Fewer questions before booking', 'Revenue increases with less effort'] } },
      ],
      socialProofStats: [
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'العميل يتصفح قائمة خدماتك', text: 'بصري. مفصل. مقنع.', description: 'عميل يفتح صفحة خدماتك ويرى قائمة منظمة بشكل جميل. كل خدمة لها صور وأوصاف ومدة وأسعار. يعرف بالضبط ما يتوقعه.', listSub: ['صور وفيديوهات لكل خدمة', 'أوصاف واضحة ومدة', 'أسعار شفافة تبني الثقة'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يرون الصور والفيديوهات', text: 'أفضل أعمالك معروضة', description: 'صور قبل/بعد وفيديوهات التصفيف وشهادات العملاء تعطي العملاء معاينة لما يتوقعونه. الإثبات البصري يزيل التردد ويدفع الحجوزات.', listSub: ['صور تحول قبل/بعد', 'فيديوهات عرض الخدمات', 'شهادات عملاء حقيقية'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/payment-collection.webp', mainImageMobile: '/images/pages/business/scroll/payment-collection-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يختارون بثقة', text: 'بدون تخمين. فقط يقين.', description: 'العميل يختار بالضبط الخدمة التي يريدها. بدون ارتباك حول ما هو مشمول أو كم يستغرق أو كم يكلف. يحجزون لأنهم يثقون بالنتيجة مسبقًا.', listSub: ['تفاصيل الخدمة تزيل الارتباك', 'فئات متعددة منظمة بوضوح', 'الإضافات والباقات مرئية'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', mainImageMobile: '/images/pages/business/scroll/booking-confirmed-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يحجزون فورًا', text: 'الثقة تتحول إلى إيرادات', description: 'العميل يحجز الخدمة ويختار وقتًا ويدفع. معرض أعمالك البصري قام بالبيع. تحصل على حجز مؤكد بدون رسالة واحدة.', listSub: ['تحويل أعلى من القوائم البصرية', 'أسئلة أقل قبل الحجز', 'الإيرادات تزداد بجهد أقل'] } },
      ],
      socialProofStats: [
  ...
  professional: {
    en: {
      hero: {
        ...
        subHeadline: 'Put your best work in front of people, show the transformations, and let the results argue for you. Clients book what they can see.',
        ctaText: 'Start Your Free Trial',
        ctaLink: '/get-the-app',
        trustLine: 'Free to join. No credit card required.',
        answerBlock: { question: 'How does a service portfolio help beauty professionals?', answer: 'A portfolio puts your best work on display: before and after photos, client transformations and clear service descriptions. People browse the gallery, see real results and book on the strength of them. Your skill does the marketing.' },
      },
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/professional/scroll/staff-details.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Client Finds Your Profile', text: 'Your Gallery. Your Reputation.', description: 'Someone finds your profile and the first thing they see is your gallery. Before and after photos, styling work and client reviews make the case for you.', listSub: ['Portfolio gallery on your profile', 'Before/after transformation photos', 'Client reviews alongside your work'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'They Browse Your Work Gallery', text: 'Real Results. Real Confidence.', description: 'They scroll a portfolio organised by service type. Colour transformations, styling examples and detailed descriptions show what you can actually do.', listSub: ['Organized by service type', 'Detailed descriptions per photo', 'Shows your range and expertise'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', mainImageMobile: '/images/pages/business/scroll/booking-confirmed-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'Reviews Alongside Photos', text: 'Social Proof That Converts', description: 'Reviews sit beside the photos, so people get the result and the experience of getting it together. That pairing is what builds trust.', listSub: ['Reviews matched to services', 'Star ratings visible', 'Authentic client experiences'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'They Book Based on What They See', text: 'Your Skills Sell Themselves.', description: 'They pick the service from your examples and book without hesitating, because they have already seen the work. Nobody has to sell them anything.', listSub: ['Book directly from your portfolio', 'Confident clients, fewer cancellations', 'Your work does the marketing'] } },
      ],
      socialProofStats: [
    ...
    ar: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يتصفحون معرض أعمالك', text: 'نتائج حقيقية. ثقة حقيقية.', description: 'العميل يتصفح معرض أعمالك المنظم حسب نوع الخدمة. تحولات ألوان الشعر وأمثلة التصفيف والأوصاف المفصلة تُظهر نطاقك وخبرتك.', listSub: ['منظم حسب نوع الخدمة', 'أوصاف مفصلة لكل صورة', 'يُظهر نطاقك وخبرتك'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', mainImageMobile: '/images/pages/business/scroll/booking-confirmed-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'المراجعات بجانب الصور', text: 'إثبات اجتماعي يحقق التحويل', description: 'مراجعات العملاء تظهر بجانب صور معرض أعمالك. العملاء المحتملون يرون النتيجة البصرية والتجربة المكتوبة. هذا المزيج يبني الثقة ويدفع الحجوزات.', listSub: ['مراجعات مطابقة للخدمات', 'تقييمات النجوم مرئية', 'تجارب عملاء حقيقية'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', mainImageMobile: '/images/pages/business/scroll/ai-receptionist-chat-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يحجزون بناءً على ما يرونه', text: 'مهاراتك تبيع نفسها.', description: 'العميل يختار الخدمة بالضبط بناءً على أمثلة معرض أعمالك. يحجز بثقة لأنه رأى مسبقًا ما يمكنك فعله. بدون حاجة لعرض بيع.', listSub: ['حجز مباشر من معرض أعمالك', 'عملاء واثقون وإلغاءات أقل', 'عملك يقوم بالتسويق'] } },
      ],
      socialProofStats: [
