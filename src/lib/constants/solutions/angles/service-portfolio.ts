...
const servicePortfolioAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  business: {
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'العميل يتصفح قائمة خدماتك', text: 'بصري. مفصل. مقنع.', description: 'عميل يفتح صفحة خدماتك ويرى قائمة منظمة بشكل جميل. كل خدمة لها صور وأوصاف ومدة وأسعار. يعرف بالضبط ما يتوقعه.', listSub: ['صور وفيديوهات لكل خدمة', 'أوصاف واضحة ومدة', 'أسعار شفافة تبني الثقة'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يرون الصور والفيديوهات', text: 'أفضل أعمالك معروضة', description: 'صور قبل/بعد وفيديوهات التصفيف وشهادات العملاء تعطي العملاء معاينة لما يتوقعونه. الإثبات البصري يزيل التردد ويدفع الحجوزات.', listSub: ['صور تحول قبل/بعد', 'فيديوهات عرض الخدمات', 'شهادات عملاء حقيقية'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/payment-collection.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يختارون بثقة', text: 'بدون تخمين. فقط يقين.', description: 'العميل يختار بالضبط الخدمة التي يريدها. بدون ارتباك حول ما هو مشمول أو كم يستغرق أو كم يكلف. يحجزون لأنهم يثقون بالنتيجة مسبقًا.', listSub: ['تفاصيل الخدمة تزيل الارتباك', 'فئات متعددة منظمة بوضوح', 'الإضافات والباقات مرئية'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يحجزون فورًا', text: 'الثقة تتحول إلى إيرادات', description: 'العميل يحجز الخدمة ويختار وقتًا ويدفع. معرض أعمالك البصري قام بالبيع. تحصل على حجز مؤكد بدون رسالة واحدة.', listSub: ['تحويل أعلى من القوائم البصرية', 'أسئلة أقل قبل الحجز', 'الإيرادات تزداد بجهد أقل'] } },
      ],
      socialProofStats: [
  ...
  professional: {
    ...
    ar: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يتصفحون معرض أعمالك', text: 'نتائج حقيقية. ثقة حقيقية.', description: 'العميل يتصفح معرض أعمالك المنظم حسب نوع الخدمة. تحولات ألوان الشعر وأمثلة التصفيف والأوصاف المفصلة تُظهر نطاقك وخبرتك.', listSub: ['منظم حسب نوع الخدمة', 'أوصاف مفصلة لكل صورة', 'يُظهر نطاقك وخبرتك'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/booking-confirmed.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', secondBg: '/images/pages/business/scroll/stars.webp', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'المراجعات بجانب الصور', text: 'إثبات اجتماعي يحقق التحويل', description: 'مراجعات العملاء تظهر بجانب صور معرض أعمالك. العملاء المحتملون يرون النتيجة البصرية والتجربة المكتوبة. هذا المزيج يبني الثقة ويدفع الحجوزات.', listSub: ['مراجعات مطابقة للخدمات', 'تقييمات النجوم مرئية', 'تجارب عملاء حقيقية'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/ai-receptionist-chat.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يحجزون بناءً على ما يرونه', text: 'مهاراتك تبيع نفسها.', description: 'العميل يختار الخدمة بالضبط بناءً على أمثلة معرض أعمالك. يحجز بثقة لأنه رأى مسبقًا ما يمكنك فعله. بدون حاجة لعرض بيع.', listSub: ['حجز مباشر من معرض أعمالك', 'عملاء واثقون وإلغاءات أقل', 'عملك يقوم بالتسويق'] } },
      ],
      socialProofStats: [
