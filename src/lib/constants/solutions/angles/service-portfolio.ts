  ...
  professional: {
    en: {
      ...
      scrollSections: [
        ...
        { sortId: 2, mainImage: '/images/pages/business/scroll/smart-scheduling.webp', mainImageMobile: '/images/pages/business/scroll/smart-scheduling-mobile.webp', firstBg: '/images/pages/business/scroll/leaf-bg.webp', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'They Browse Your Work Gallery', text: 'Real Results. Real Confidence.', description: 'The client scrolls through your portfolio organized by service type. Hair color transformations, styling examples, and detailed descriptions show your range and expertise.', listSub: ['Organized by service type', 'Detailed descriptions per photo', 'Shows your range and expertise'] } },
