...
const servicePortfolioAngle: Record<'business' | 'professional', I18nContent<LandingPageContent>> = {
  ...
  professional: {
    ...
    ar: {
      ...
      scrollSections: [
        { sortId: 1, mainImage: '/images/pages/professional/scroll/staff-details.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', secondBg: '/images/pages/business/scroll/stars.png', ...scrollStyles.panel1, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'عميل يجد ملفك الشخصي', text: 'معرضك. سمعتك.', description: 'عميل محتمل يكتشف ملفك ويرى فورًا معرض أعمالك. صور قبل/بعد وعرض التصفيف ومراجعات العملاء تمنحه الثقة في مهاراتك.', listSub: ['معرض أعمال على ملفك الشخصي', 'صور تحول قبل/بعد', 'مراجعات العملاء بجانب أعمالك'] } },
        { sortId: 2, mainImage: '/images/pages/business/scroll/schedule.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', ...scrollStyles.panel2, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يتصفحون معرض أعمالك', text: 'نتائج حقيقية. ثقة حقيقية.', description: 'العميل يتصفح معرض أعمالك المنظم حسب نوع الخدمة. تحولات ألوان الشعر وأمثلة التصفيف والأوصاف المفصلة تُظهر نطاقك وخبرتك.', listSub: ['منظم حسب نوع الخدمة', 'أوصاف مفصلة لكل صورة', 'يُظهر نطاقك وخبرتك'] } },
        { sortId: 3, mainImage: '/images/pages/business/scroll/analytics.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', secondBg: '/images/pages/business/scroll/stars.png', ...scrollStyles.panel3, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'المراجعات بجانب الصور', text: 'إثبات اجتماعي يحقق التحويل', description: 'مراجعات العملاء تظهر بجانب صور معرض أعمالك. العملاء المحتملون يرون النتيجة البصرية والتجربة المكتوبة. هذا المزيج يبني الثقة ويدفع الحجوزات.', listSub: ['مراجعات مطابقة للخدمات', 'تقييمات النجوم مرئية', 'تجارب عملاء حقيقية'] } },
        { sortId: 4, mainImage: '/images/pages/business/scroll/device-mockups.png', firstBg: '/images/pages/business/scroll/leaf-bg.png', ...scrollStyles.panel4, mainImageWidth: 300, mainImageHeight: 500, infoScroll: { title: 'يحجزون بناءً على ما يرونه', text: 'مهاراتك تبيع نفسها.', description: 'العميل يختار الخدمة بالضبط بناءً على أمثلة معرض أعمالك. يحجز بثقة لأنه رأى مسبقًا ما يمكنك فعله. بدون حاجة لعرض بيع.', listSub: ['حجز مباشر من معرض أعمالك', 'عملاء واثقون وإلغاءات أقل', 'عملك يقوم بالتسويق'] } },
      ],
      socialProofStats: [
