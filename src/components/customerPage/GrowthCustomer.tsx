      ...
      <div className=" px-4 md:flex bg-[white]/90 md:bg-white">
        <div className="md:flex md:justify-between md:bg-[#D5D9D9] md:mx-[64px] md:mb-[164px] rounded-[16px] relative">
          ...
          <div className="md:w-[50%] md:px-20 md:ml-[100px] md:pb-[150px] md:pt-[150px]">
            ...
            <Button href="https://daisylnk.com/install-app" className="font-semibold w-full h-auto text-base mt-8 mb-10 px-[85px] py-[14px] rounded-[9px] md:w-[310px] hover:bg-white hover:text-primary hover:border hover:border-primary">
              {learnMore}
            </Button>
          </div>
