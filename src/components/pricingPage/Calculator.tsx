        ...
        <div className="mt-6 w-full ltr:mr-12">
          <div className="flex flex-col md:flex-row justify-between mb-8 md:mb-6">
            ...
            <Input
              ...
              inputMode="numeric"
              pattern="[0-9]*"
              aria-label={titleTypeCalculate?.firstInput.title || 'Number of staff'}
          ...
          <div className="flex flex-col md:flex-row justify-between mb-8 md:mb-6">
            ...
            <Input
              ...
              inputMode="numeric"
              pattern="[0-9]*"
              aria-label={titleTypeCalculate?.secondInput.title || 'Number of workspaces'}
          ...
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <Input
              ...
              inputMode="numeric"
              pattern="[0-9]*"
              aria-label={titleTypeCalculate?.thirdInput.title || 'Number of countries'}
              className="w-full md:w-20 md:ml-8 mt-4 md:mt-0 focus:border-[#A67F6B] text-center py-2"
